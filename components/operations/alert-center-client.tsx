...
import { CctvAlertEvidence, IotAlertEvidence } from "@/components/operations/alert-evidence";
...
function AlertDetailPanel({ detail, canManage, onStatusSave }: { detail: AlertDetail; canManage: boolean; onStatusSave: (status: AlertStatus, note: string) => Promise<void> }) {
  ...
  return <div className="space-y-5">
    ...
    {(detail.source === "CCTV" || detail.source === "CCTV_AI") && <CctvAlertEvidence evidence={detail.cctvEvidence} />}
    {detail.source === "IOT" && <IotAlertEvidence evidence={detail.iotEvidence} severity={detail.severity} severityLabel={detail.severityLabel} />}
