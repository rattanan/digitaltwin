        ...
        <div className="grid w-full overflow-hidden rounded-[2rem] border border-white/10 bg-[#0a1a2d]/80 shadow-2xl shadow-slate-950/40 lg:grid-cols-[1.05fr_0.95fr]">
          <section className="grid-bg relative hidden min-h-[650px] flex-col justify-between overflow-hidden p-10 lg:flex xl:p-14">
            ...
            <div className="relative">
              <div className="flex items-center gap-3"><NTLogo mode="dark" width={148} height={62} /><div><p className="text-[10px] uppercase tracking-[0.2em] text-[var(--nt-yellow)]/80">Digital Twin</p><p className="font-semibold">Intelligence City Platform</p></div></div>
          ...
          <section className="flex min-h-[650px] flex-col justify-center p-6 sm:p-10 xl:p-14">
            <div className="mx-auto w-full max-w-md">
              <div className="mb-10 lg:hidden"><div className="flex items-center gap-3"><NTLogo mode="dark" width={118} height={50} /><div><p className="text-[10px] uppercase tracking-[0.2em] text-[var(--nt-yellow)]/80">Digital Twin</p><p className="text-sm font-semibold">Intelligence City Platform</p></div></div></div>
              ...
              <p className="mt-8 text-center text-[11px] text-slate-600">ข้อมูลในระบบนี้เป็นข้อมูลสาธิต · <span className="text-slate-500">Asia/Bangkok</span></p><Link href="/" className="mt-4 block text-center text-xs text-[var(--nt-blue-light)] hover:text-white">← กลับหน้าแนะนำโครงการ</Link>
            </div>
          </section>
        </div>
      </div>
